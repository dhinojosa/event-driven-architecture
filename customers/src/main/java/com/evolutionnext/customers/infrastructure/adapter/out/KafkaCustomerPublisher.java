package com.evolutionnext.customers.infrastructure.adapter.out;

import com.evolutionnext.customers.CustomerCreatedMessage;
...
public class KafkaCustomerPublisher implements CustomerPublisher {
    ...
    public void publish(CustomerEvent customerEvent) {
        ProducerRecord<String, CustomerCreatedMessage> producerRecord = switch (customerEvent) {
