...
public class ProductPublisherApplicationService implements PublicProductCommandPort {
    private static final Logger logger = LoggerFactory.getLogger(ProductPublisherApplicationService.class);
    private final ProductPublisher productPublisher;

    public ProductPublisherApplicationService(ProductPublisher productPublisher) {
